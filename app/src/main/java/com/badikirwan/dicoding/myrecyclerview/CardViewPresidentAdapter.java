...
public class CardViewPresidentAdapter extends RecyclerView.Adapter<CardViewPresidentAdapter.CardViewViewHolder> {
    ...
    public CardViewPresidentAdapter.CardViewViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        CardViewViewHolder viewViewHolder = new CardViewViewHolder(view);
    ...
    public class CardViewViewHolder extends RecyclerView.ViewHolder {
        ...
        public CardViewViewHolder(View view) {
            super(view);
            imgPhoto = (ImageView) view.findViewById(R.id.img_item_photo);
            tvName = (TextView) view.findViewById(R.id.tv_item_name);
            tvRemarks = (TextView) view.findViewById(R.id.tv_item_remarks);
            btnFavorite = (Button) view.findViewById(R.id.btn_set_favorite);
            btnShare = (Button) view.findViewById(R.id.btn_set_share);
        }
    }
